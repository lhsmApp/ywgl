...
<body class="no-skin">
										...
										<tr>
											...
											<td class="center">											
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.COURSE_TYPE_ID}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													
													
													<a class="btn btn-xs btn-danger" onclick="del('${var.COURSE_TYPE_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.COURSE_TYPE_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<li>
																<a style="cursor:pointer;" onclick="del('${var.COURSE_TYPE_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									...
									<a class="btn btn-mini btn-success" onclick="add('${COURSETYPE_ID}');">新增</a>
									
									<c:if test="${null != pd.COURSE_TYPE_ID && pd.COURSE_TYPE_ID != ''}">
									<a class="btn btn-mini btn-success" onclick="goSondict('${pd.COURSE_TYPE_PARENT_ID}');">返回</a>
									</c:if>
								</td>
	...
	<script type="text/javascript">
		...
		//新增
		function add(COURSETYPE_ID){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>coursetype/goAdd.do?COURSETYPE_ID='+COURSETYPE_ID;
			 diag.Width = 600;
			 diag.Height = 400;
			 ...
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
					 parent.location.href="<%=basePath%>coursetype/listTree.do?COURSETYPE_ID=${COURSETYPE_ID}&dnowPage=${page.currentPage}";
				}
				diag.close();
			 };
			 diag.show();
