...
<div class="main-container" id="main-container">
							 ...
							 <div class="widget-box transparent" id="recent-box">
						        <div class="widget-header">
						        	<h4 class="widget-title lighter smaller">
						          		<i class="ace-icon fa fa-rss orange"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">考试列表</font></font></h4>
	...
	<script type="text/javascript">
		...
		function beginExam(planId,paperId){
			window.location.href='<%=basePath%>testmain/waitAuditList.do?TEST_PLAN_ID='+planId+'&TEST_PAPER_ID='+paperId;
		}
	</script>
