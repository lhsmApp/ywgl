...
<table width="750"    border="1" align="center" cellspacing="0" bgcolor="#221144">
  ...
  <tr>
        <td height="40"  align=""left"" bgcolor="EFEFFF">新增角色</td>
		<td  colspan="3"  height="70"  align="right" bgcolor="#FFFFFF"> &nbsp; ${pd.ADD_ROLES}</td>
  </tr>
    <tr>
        <td height="40"  align="left" bgcolor="EFEFFF">删除角色</td>
		<td  colspan="3"  height="70"  align="right" bgcolor="#FFFFFF"> &nbsp; ${pd.DELETE_ROLES}</td>
  </tr>
  <tr>
