			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="page-header">
						<!-- 检索  -->
						<form class="form-inline" action="changegrcqxbg/queryList.do" id="grcqxForm" name="grcqxForm" method="post">
...
<%-- 														<c:if test="${var.BILL_STATE == '1' }"><span class="label label-success arrowed">正常</span></c:if> --%>
	...
	<script type="text/javascript">
		...
		function showDetail(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="GRC权限变更单"+Id+"详情";
			 diag.URL = '<%=basePath%>changegrcqxbg/detailView.do?BILL_CODE='+Id;
			 diag.Width = 800;
			 diag.Height = 405;			
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>changegrcqxbg/exportGrcqxbg.do';
		}
	</script>
