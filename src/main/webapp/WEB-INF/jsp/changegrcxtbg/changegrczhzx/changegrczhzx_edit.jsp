					...
					<form action="changegrczhzx/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="ACCOUNT_NAME" id="ACCOUNT_NAME" value="${pd.ACCOUNT_NAME}" maxlength="100" placeholder="这里输入备注12" title="备注12" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注13:</td>
								<td><input type="text" name="CANCLE_REASON" id="CANCLE_REASON" value="${pd.CANCLE_REASON}" maxlength="200" placeholder="这里输入备注13" title="备注13" style="width:98%;"/></td>
							</tr>
							<tr>
