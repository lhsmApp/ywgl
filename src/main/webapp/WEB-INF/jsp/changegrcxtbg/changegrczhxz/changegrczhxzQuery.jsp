			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="page-header">
						<!-- 检索  -->
						<form class="form-inline" action="changegrczhxz/queryList.do" id="grczhxzForm" name="grczhxzForm" method="post">
									...
									<c:when test="${not empty varList}">
										<c:forEach items="${varList}" var="var" varStatus="vs">	
											<c:if test="${var.APPROVAL_STATE != null }">
												...
												<td class='center'style="width: 100px;">${var.ACCOUNT_NEW}</td>
												<td class='center'style="width: 100px;">${var.ACCOUNT_VALIDITY}</td>
												<td class='center'style="width: 200px;">${var.ACCOUNT_ROLES}</td>
												<td class='center'style="width: 200px;">${var.ACCOUNT_REASON}</td>					
												<td class='center'style="width: 200px;">${var.USERNAME}</td>
												<td class='center'style="width: 200px;">${var.USER_DEPTNAME}</td>
												<td class='center'style="width: 200px;">${var.USER_JOB}</td>
												<td class='center'style="width: 200px;">${var.USER_CONTACT}</td>
...
<%-- 														<c:if test="${var.BILL_STATE == '1' }"><span class="label label-success arrowed">正常</span></c:if> --%>
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>changegrczhxz/exportGrczhxz.do';
		}
	</script>
