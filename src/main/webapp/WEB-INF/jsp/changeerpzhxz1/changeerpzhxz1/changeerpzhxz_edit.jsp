		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="changeerpzhxz/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CHANGEERPZHXZ_ID" id="CHANGEERPZHXZ_ID" value="${pd.CHANGEERPZHXZ_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="EFFECTIVE_DATE" id="EFFECTIVE_DATE" value="${pd.EFFECTIVE_DATE}" maxlength="20" placeholder="这里输入备注10" title="备注10" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="ACCOUNT_NEW" id="ACCOUNT_NEW" value="${pd.ACCOUNT_NEW}" maxlength="100" placeholder="这里输入备注12" title="备注12" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注13:</td>
								<td><input type="text" name="ACCOUNT_VALIDITY" id="ACCOUNT_VALIDITY" value="${pd.ACCOUNT_VALIDITY}" maxlength="30" placeholder="这里输入备注13" title="备注13" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注14:</td>
								<td><input type="text" name="ACCOUNT_REASON" id="ACCOUNT_REASON" value="${pd.ACCOUNT_REASON}" maxlength="200" placeholder="这里输入备注14" title="备注14" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注15:</td>
								<td><input type="text" name="ACCOUNT_ROLES" id="ACCOUNT_ROLES" value="${pd.ACCOUNT_ROLES}" maxlength="300" placeholder="这里输入备注15" title="备注15" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注16:</td>
								<td><input type="text" name="CONFORM_PSR" id="CONFORM_PSR" value="${pd.CONFORM_PSR}" maxlength="1" placeholder="这里输入备注16" title="备注16" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注17:</td>
								<td><input type="text" name="CONFORM_SDR" id="CONFORM_SDR" value="${pd.CONFORM_SDR}" maxlength="1" placeholder="这里输入备注17" title="备注17" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注18:</td>
								<td><input type="text" name="BILL_STATE" id="BILL_STATE" value="${pd.BILL_STATE}" maxlength="10" placeholder="这里输入备注18" title="备注18" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注19:</td>
								<td><input type="text" name="BILL_USER" id="BILL_USER" value="${pd.BILL_USER}" maxlength="20" placeholder="这里输入备注19" title="备注19" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注20:</td>
								<td><input type="text" name="BILL_DATE" id="BILL_DATE" value="${pd.BILL_DATE}" maxlength="30" placeholder="这里输入备注20" title="备注20" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注21:</td>
								<td><input type="text" name="CUS_COLUMN1" id="CUS_COLUMN1" value="${pd.CUS_COLUMN1}" maxlength="30" placeholder="这里输入备注21" title="备注21" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注22:</td>
								<td><input type="text" name="CUS_COLUMN2" id="CUS_COLUMN2" value="${pd.CUS_COLUMN2}" maxlength="30" placeholder="这里输入备注22" title="备注22" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注23:</td>
								<td><input type="text" name="CUS_COLUMN3" id="CUS_COLUMN3" value="${pd.CUS_COLUMN3}" maxlength="30" placeholder="这里输入备注23" title="备注23" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注24:</td>
								<td><input type="text" name="CUS_COLUMN4" id="CUS_COLUMN4" value="${pd.CUS_COLUMN4}" maxlength="30" placeholder="这里输入备注24" title="备注24" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注25:</td>
								<td><input type="text" name="CUS_COLUMN5" id="CUS_COLUMN5" value="${pd.CUS_COLUMN5}" maxlength="30" placeholder="这里输入备注25" title="备注25" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			if($("#ACCOUNT_VALIDITY").val()==""){
				$("#ACCOUNT_VALIDITY").tips({
					side:3,
		            msg:'请输入备注13',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#ACCOUNT_VALIDITY").focus();
			return false;
			}
			if($("#ACCOUNT_REASON").val()==""){
				$("#ACCOUNT_REASON").tips({
					side:3,
		            msg:'请输入备注14',
		            bg:'#AE81FF',
				...
				$("#ACCOUNT_REASON").focus();
			return false;
			}
			if($("#ACCOUNT_ROLES").val()==""){
				$("#ACCOUNT_ROLES").tips({
					side:3,
		            msg:'请输入备注15',
		            bg:'#AE81FF',
