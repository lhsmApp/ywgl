							...
							<table style="margin-bottom:6px; float: left;">
								<tr>
									...
									<td style="vertical-align:top;padding-left:3px;">
										...
										<a class="btn btn-white btn-info btn-bold" onclick="daaBackReport('确定要驳回当前选中的申请吗?');" title="批量驳回" ><i class="ace-icon fa fa-exclamation-triangle red bigger-110"></i>批量驳回</a>
										</c:if>
