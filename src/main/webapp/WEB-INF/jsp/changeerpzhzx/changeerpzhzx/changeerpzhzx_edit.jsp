		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="changeerpzhzx/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CHANGEERPZHZX_ID" id="CHANGEERPZHZX_ID" value="${pd.CHANGEERPZHZX_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="ACCOUNT_REMOVE" id="ACCOUNT_REMOVE" value="${pd.ACCOUNT_REMOVE}" maxlength="100" placeholder="这里输入备注12" title="备注12" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注13:</td>
								<td><input type="text" name="ACCOUNT_REASON" id="ACCOUNT_REASON" value="${pd.ACCOUNT_REASON}" maxlength="200" placeholder="这里输入备注13" title="备注13" style="width:98%;"/></td>
							</tr>
							<tr>
