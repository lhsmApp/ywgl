...
public class ChangeGrcZhzxController extends BaseController {
	...
	Map<String, TmplConfigDetail> Map_SetColumnsListGrczhzx = new LinkedHashMap<String, TmplConfigDetail>();
	/**保存
	 * @param
	 * @throws Exception
	 */
	...
	public ModelAndView queryList(Page page) throws Exception{
		...
		mv.addObject("pd", pd);
		Map_SetColumnsListGrczhzx.put("BILL_CODE", new TmplConfigDetail("BILL_CODE", "申请单号", "1", false));	
		Map_SetColumnsListGrczhzx.put("UNIT_NAME", new TmplConfigDetail("UNIT_NAME", "申请单位", "1", false));
		Map_SetColumnsListGrczhzx.put("DEPT_NAME", new TmplConfigDetail("DEPT_NAME", "申请部门", "1", false));
		Map_SetColumnsListGrczhzx.put("ACCOUNT_NAME", new TmplConfigDetail("ACCOUNT_NAME", "帐号", "1", false));
		Map_SetColumnsListGrczhzx.put("CANCLE_REASON", new TmplConfigDetail("CANCLE_REASON", "帐号撤销原因", "1", false));
		Map_SetColumnsListGrczhzx.put("USERNAME",new TmplConfigDetail("USERNAME", "申请人", "1", false));
		Map_SetColumnsListGrczhzx.put("USER_DEPTNAME", new TmplConfigDetail("USER_DEPTNAME", "申请人部门", "1", false));
		Map_SetColumnsListGrczhzx.put("USER_JOB", new TmplConfigDetail("USER_JOB", "申请人岗位", "1", true));
		Map_SetColumnsListGrczhzx.put("USER_CONTACT", new TmplConfigDetail("USER_CONTACT", "联系方式", "1", false));
		Map_SetColumnsListGrczhzx.put("ENTRY_DATE", new TmplConfigDetail("ENTRY_DATE", "申请日期", "1", true));
		Map_SetColumnsListGrczhzx.put("APPROVAL_STATE", new TmplConfigDetail("APPROVAL_STATE", "处理状态", "1", false));
		return mv;
	}
	/**显示变更详情
	 * @param
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/exportGrczhzx")
	public ModelAndView exportGrczhzx(Page page) throws Exception {
		PageData pd = new PageData();
		PageData pd1 = new PageData();
		PageData pd2 = new PageData();
		pd = this.getPageData();
		...
		return export(varOList, "GRC帐号注销_" + DateUtils.getCurrentTime(DateFormatUtils.DATE_FORMAT1),
				Map_SetColumnsListGrczhzx);
	}
