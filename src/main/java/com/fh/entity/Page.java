 ...
 * 分页类
 * 
 * @author lhsmplus 创建时间：2014年6月28日
 */
public class Page {
	...
	private String pageStr2; // Ajax局部分页，最终页面显示的底部翻页导航，详细见：getPageStr();
	...
	public String getPageStr2() {
		...
		if (totalResult > 0) {
			...
			if (currentPage == 1) {
				sb.append("	<li><a>共<font color=red>" + totalResult + "</font>条</a></li>\n");
				sb.append(
						"	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:60px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
				sb.append(
						"	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
				sb.append("	<li><a>首页</a></li>\n");
				sb.append("	<li><a>上页</a></li>\n");
		...
		pageStr2 = sb.toString();
		return pageStr2;
	}

	public void setPageStr2(String pageStr2) {
		this.pageStr2 = pageStr2;
	}
